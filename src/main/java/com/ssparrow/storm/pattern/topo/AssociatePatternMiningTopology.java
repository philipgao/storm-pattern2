...
import com.ssparrow.storm.pattern.bolt.SingleItemCountBolt;
import com.ssparrow.storm.pattern.bolt.ItemSetCountBolt;
import com.ssparrow.storm.pattern.bolt.PatternTransactionSetSplitBolt;
import com.ssparrow.storm.pattern.bolt.TransactionItemsetBuildBolt;
...
public class AssociatePatternMiningTopology {
	...
	public static void main(String [] args) throws Exception{
		...
		builder.setBolt("SingleItemCount", new SingleItemCountBolt(threshold), 5)
			.fieldsGrouping("TransactionItemSpout", new Fields("item"));
		
		builder.setBolt("TransactionItemsetBuild", new TransactionItemsetBuildBolt(), 5)
			.fieldsGrouping("PatternTransactionSetSplit", new Fields("tid"));
		
		builder.setBolt("ItemSetCount", new ItemSetCountBolt(threshold), 5)
			.fieldsGrouping("TransactionItemsetBuild", new Fields("itemset"));
		
		builder.setBolt("PatternTransactionSetSplit", new PatternTransactionSetSplitBolt(), 5)
			.fieldsGrouping("SingleItemCount", new Fields("itemset"))
			.fieldsGrouping("ItemSetCount", new Fields("itemset"));
